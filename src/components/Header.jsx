...
const Header = () => {
  ...
  return (
    <main>
        <div className="font-bold text-2xl px-11 py-4 shadow-md flex justify-between items-center dark:bg-gray-900 dark:border-b dark:border-white dark:shadow-white">
          <Link to='/'>
